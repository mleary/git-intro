...
Git doesn't track when you save the file, you need to commit changes
...
Q: Will I feel foolish learning Git?
...
Q: What is the difference between Git vs Github?
...
Q: What if I don't want to track a file?
...
**Repo** - Short for repository - Really just a folder or place with files

**Origin/Remote** - where "real" code lives and is shared (TFS, Github)

**Local** - Your personal copy of remote

**Clone** - Copying origin/remote repo to your local computer

**Branch** - A "draft version", where you can work on code and not impact others

**Commit** - Documenitng changes in a  "save"

**Pull Request** - Asking others to accept your changes 
